...
import type { Delegation } from "@/hooks/useAttendanceV2";
...
export const DelegationSection: React.FC<DelegationSectionProps> = ({
  ...
  return (
    <div className="space-y-4" data-tour="attendance-v2-settings-delegation">
      <SectionIntro
        icon={UserPlus}
      ...
      <div className="rounded-2xl border bg-card p-4 shadow-sm" data-tour="attendance-v2-settings-delegation-list">
