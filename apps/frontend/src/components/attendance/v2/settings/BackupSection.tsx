...
import type { DayEvent, HolidayRecord, MonthSnapshot } from "@/hooks/useAttendanceV2";
...
export const BackupSection: React.FC<BackupSectionProps> = ({
  ...
  return (
    <div className="space-y-4" data-tour="attendance-v2-settings-backup">
      <SectionIntro
        icon={Camera}
      ...
      <div className="grid gap-4">
        {/* Summary Card */}
        <div className="rounded-2xl border bg-card p-4 shadow-sm" data-tour="attendance-v2-settings-backup-summary">
