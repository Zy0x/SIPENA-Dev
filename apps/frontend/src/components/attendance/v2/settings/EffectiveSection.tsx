...
import type { DayEvent, HolidayRecord } from "@/hooks/useAttendanceV2";
...
export const EffectiveSection: React.FC<EffectiveSectionProps> = ({
  ...
  return (
    <div className="space-y-4" data-tour="attendance-v2-settings-effective">
      <SectionIntro
        icon={CalendarOff}
      ...
      <div className="grid gap-4">
        {/* Holidays Card */}
        <div className="rounded-2xl border bg-card p-4 shadow-sm" data-tour="attendance-v2-settings-effective-holiday">
        ...
        {/* Events Card */}
        <div className="rounded-2xl border bg-card p-4 shadow-sm" data-tour="attendance-v2-settings-effective-event">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between border-b pb-3 mb-3">
            <div>
        ...
        <CollapsibleCard
          ...
          icon={CheckCircle2}
          dataTour="attendance-v2-settings-effective-preview"
        >
