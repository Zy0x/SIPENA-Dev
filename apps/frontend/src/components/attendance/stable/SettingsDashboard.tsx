...
import type { DayEvent, Delegation, HolidayRecord, MonthSnapshot, RecapProfile } from "@/hooks/useAttendanceStable";
...
const SECTION_ITEMS: SectionNavItem[] = [
  { id: "calendar", title: "Kalender", detail: "Hari Kerja", icon: CalendarDays, tour: "attendance-settings-calendar" },
  { id: "effective", title: "Libur & Kegiatan", detail: "Pengecualian", icon: CalendarOff, tour: "attendance-settings-effective" },
  { id: "recap", title: "Aturan Rekap", detail: "Rumus Hitung", icon: FileSpreadsheet, tour: "attendance-settings-recap" },
  { id: "audit", title: "Riwayat", detail: "Audit Log", icon: Clock, tour: "attendance-settings-audit" },
  { id: "delegation", title: "Delegasi", detail: "Akses Guru", icon: UserPlus, tour: "attendance-settings-delegation" },
  { id: "backup", title: "Backup", detail: "Snapshot", icon: Camera, tour: "attendance-settings-backup" },
];
...
export const SettingsDashboard: React.FC<SettingsDashboardProps> = ({
  ...
  const settingsTourSteps: TourStep[] = useMemo(
    () => [
      {
        target: "[data-tour='attendance-settings-header']",
      ...
      {
        target: "[data-tour='attendance-settings-nav-calendar']",
      ...
      {
        target: "[data-tour='attendance-settings-calendar-format']",
      ...
      {
        target: "[data-tour='attendance-settings-calendar-override']",
      ...
      {
        target: "[data-tour='attendance-settings-nav-effective']",
      ...
      {
        target: "[data-tour='attendance-settings-effective-holiday']",
      ...
      {
        target: "[data-tour='attendance-settings-effective-event']",
      ...
      {
        target: "[data-tour='attendance-settings-effective-preview']",
      ...
      {
        target: "[data-tour='attendance-settings-nav-recap']",
      ...
      {
        target: "[data-tour='attendance-settings-recap-denominator']",
      ...
      {
        target: "[data-tour='attendance-settings-recap-mapping']",
      ...
      {
        target: "[data-tour='attendance-settings-recap-nisn']",
      ...
      {
        target: "[data-tour='attendance-settings-nav-audit']",
      ...
      {
        target: "[data-tour='attendance-settings-audit-history']",
      ...
      {
        target: "[data-tour='attendance-settings-nav-delegation']",
      ...
      {
        target: "[data-tour='attendance-settings-delegation-add']",
      ...
      {
        target: "[data-tour='attendance-settings-delegation-list']",
      ...
      {
        target: "[data-tour='attendance-settings-nav-backup']",
      ...
      {
        target: "[data-tour='attendance-settings-backup-create']",
      ...
      {
        target: "[data-tour='attendance-settings-backup-summary']",
      ...
      {
        target: "[data-tour='attendance-settings-backup-list']",
  ...
  const tourButtonProps = {
    tourKey: "attendance-settings" as const,
    onBeforeStart: async () => {
      ...
      <Drawer open={open} onOpenChange={onOpenChange}>
        <DrawerPortal>
          ...
          <DrawerContent className="fixed inset-x-0 bottom-0 z-[10090] mt-24 flex h-[90dvh] max-h-[90dvh] flex-col rounded-t-3xl border bg-background overflow-hidden outline-none">
            ...
            {/* Header */}
            <div className="px-5 pt-3 pb-2 shrink-0" data-tour="attendance-settings-header">
              <div className="flex items-center justify-between gap-3">
                <div className="min-w-0 flex-1">
                  <DrawerTitle className="flex items-center gap-2 text-base font-extrabold text-foreground">
                    ...
                    <span className="truncate">Pengaturan Presensi</span>
                  </DrawerTitle>
                </div>
                <TourButton
                  {...tourButtonProps}
                ...
                {SECTION_ITEMS.map((item) => {
                  ...
                  return (
                    <button
                      key={item.id}
                      type="button"
                      data-tour={`attendance-settings-nav-${item.id}`}
                      aria-pressed={active}
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        <DialogHeader
          ...
          data-tour="attendance-settings-header"
        >
        ...
        <div className="min-h-0 flex-1 flex flex-row overflow-hidden">
          <aside
            ...
            data-tour="attendance-settings-nav"
          >
            {SECTION_ITEMS.map((item) => {
              const Icon = item.icon;
              const active = settingsSection === item.id;
          ...
          <div className="flex items-center justify-between px-6 py-4">
            <div className="flex flex-col gap-1 min-w-0">
              ...
              <p className="flex items-start gap-1.5 text-[11px] leading-relaxed text-muted-foreground">
                ...
                <span className="line-clamp-1 font-medium">Pengaturan hanya berlaku untuk Presensi. Data presensi V1 tetap aman.</span>
              </p>
            </div>
            <Button
              type="button"
