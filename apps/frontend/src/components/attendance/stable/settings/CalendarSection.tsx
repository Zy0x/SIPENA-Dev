...
import type { HolidayRecord } from "@/hooks/useAttendanceStable";
...
export const CalendarSection: React.FC<CalendarSectionProps> = ({
  ...
  return (
    <div className="space-y-4" data-tour="attendance-settings-calendar">
      <SectionIntro
        icon={CalendarDays}
        ...
        help={
          <InfoHelp
            ...
            dataTour="attendance-settings-info-help"
          />
        }
      />
      <div className="grid gap-4">
        {/* Format Hari Sekolah */}
        <div className="rounded-2xl border bg-card p-4 shadow-sm" data-tour="attendance-settings-calendar-format">
          <div className="mb-3">
        ...
        <CollapsibleCard
          ...
          icon={Globe}
          dataTour="attendance-settings-calendar-override"
        >
