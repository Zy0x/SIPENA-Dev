...
interface AttendanceControlsProps {
  ...
  handleExportPNG: (quality: "hd" | "4k", sig?: any, inclSig?: boolean, style?: any, fit?: boolean, paper?: any, cols?: string[]) => Promise<void>;
              ...
              <div data-tour="export-attendance">
                <UnifiedExportStudio
                  ...
                  onExport={async ({ formatId, includeSignature: nextIncludeSignature, signatureConfig: nextSignatureConfig, paperSize: nextPaperSize, documentStyle: nextDocumentStyle, autoFitOnePage: nextAutoFitOnePage }) => {
                    ...
                    await handleExportPNG(formatId === "png-4k" ? "4k" : "hd", nextSignatureConfig, nextIncludeSignature, nextDocumentStyle, nextAutoFitOnePage, nextPaperSize, selectedAttendanceColumnKeys);
                  }}
