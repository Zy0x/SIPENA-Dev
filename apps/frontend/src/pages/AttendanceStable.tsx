...
import { useAttendanceStable, type AttendanceStatusValue, type DayEvent, type RecapProfile } from "@/hooks/useAttendanceStable";
...
import { SettingsDashboard } from "@/components/attendance/stable/SettingsDashboard";
import { BulkApplySettingsDialog } from "@/components/attendance/stable/BulkApplySettingsDialog";
import { HolidayAddDialog } from "@/components/attendance/stable/HolidayAddDialog";
import { DayEventAddDialog } from "@/components/attendance/stable/DayEventAddDialog";
import { DelegationAddDialog } from "@/components/attendance/stable/DelegationAddDialog";
import { SnapshotReasonDialog } from "@/components/attendance/stable/SnapshotReasonDialog";
...
// Hooks & stable attendance sub-components
import { useAttendanceStableExport } from "@/hooks/useAttendanceStableExport";
import { AttendanceControls } from "@/components/attendance/stable/AttendanceControls";
import { AttendanceDailyView } from "@/components/attendance/stable/AttendanceDailyView";
import { AttendanceMonthlyView } from "@/components/attendance/stable/AttendanceMonthlyView";
...
export default function AttendanceStablePage() {
  ...
  useEffect(() => {
    ...
    window.addEventListener("attendance_stable_conflict", handleConflict);
    return () => window.removeEventListener("attendance_stable_conflict", handleConflict);
  }, [showWarning]);
  ...
  // Load students and stable attendance data
  ...
  const {
    ...
    isSaving, isLoading, promoteExperimentalToStable, isPromoting,
  ...
  } = useAttendanceStable(selectedClassId === "tour-dummy-class" ? "" : selectedClassId, currentMonth, workDayFormat);
