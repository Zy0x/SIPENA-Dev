...
describe("phase 12 grade import regression suite", () => {
  ...
  it("guards unified contextual import policy in source until a component test harness is added", () => {
    ...
    expect(dialogSource).toContain('const importSteps = ["Upload", "SIPENA Mengecek", "AI Agent Menyelesaikan", "Review Akhir", "Simpan"]');
    ...
    expect(dialogSource).toContain("AI Agent membantu menyelesaikan item yang belum jelas");
    expect(dialogSource).toContain("Saran ini tetap perlu dicek");
    expect(dialogSource).toContain("Jalankan AI Agent");
