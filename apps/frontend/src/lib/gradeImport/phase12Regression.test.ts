...
describe("phase 12 grade import regression suite", () => {
  ...
  it("guards unified contextual import policy in source until a component test harness is added", () => {
    ...
    expect(restoreDialogSource).toContain("sipena-preview-grid-wrap sipena-restore-preview-wrap");
    expect(restoreDialogSource).toContain("sipena-preview-table sipena-restore-preview-table");
    expect(restoreDialogSource).toContain("sipena-restore-cell--overwrite");
    ...
    expect(globalStyles).toContain(".sipena-restore-preview-table");
    expect(globalStyles).toContain(".sipena-restore-cell--added");
    expect(globalStyles).toContain(".sipena-restore-cell--overwrite");
    expect(globalStyles).toContain("max-height: min(58dvh, 620px)");
