...
export const FEATURE_REGISTRY = [
  ...
  { id: "attendanceV2", key: "page.attendance-v2", name: "Presensi V2", description: "Pusat kalender akademik dan presensi cerdas V2. V1 tetap menjadi default dan fallback produksi.", type: "page", defaultEnabled: false, globalKillSwitch: true, riskLevel: "critical", owner: "attendance", isMajor: true, metadata: { route: "/attendance-v2", owner: "attendance", isMajor: true, fallback: "/attendance", defaultEngine: "v1" } },
