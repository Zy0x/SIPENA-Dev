...
export function useTouchScrollClickGuard() {
  useEffect(() => {
    ...
    const handlePointerDown = (event: PointerEvent) => {
      ...
      // A fresh stationary gesture is a new navigation intent. The click
      // generated by the scrolling gesture itself is still suppressed on
      // pointerup, but a later deliberate tap must not inherit that lock.
